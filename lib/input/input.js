...
var Input = function Input(_ref) {
  ...
  var className = _ref.className,
      ...
      selectboxProps = _objectWithoutProperties(_ref, ['className', 'style', 'type', 'name', 'label', 'placeholder', 'disabled', 'required', 'options', 'value', 'hiddenLabel', 'asynch', 'creatable', 'loadOptions', 'error', 'validate', 'onPaste', 'normalize']);
