...
var Input = function Input(_ref) {
  var className = _ref.className,
      ...
      error = _ref.error,
      selectboxProps = _objectWithoutProperties(_ref, ['className', 'style', 'type', 'name', 'label', 'placeholder', 'disabled', 'required', 'options', 'value', 'asynch', 'creatable', 'loadOptions', 'error']);
