...
var Input = function Input(_ref) {
  ...
  var classes = (0, _classnames4.default)(_inputStyles2.default.input, _defineProperty({}, _inputStyles2.default.showLabel, !hiddenLabel), _inputStyles2.default['type-' + type], className);
  ...
  var select = _react2.default.createElement(SelectComponent, _extends({
    ...
    className: (0, _classnames4.default)(_defineProperty({}, _inputStyles2.default.error, !!error))
  ...
  return _react2.default.createElement(
    ...
    type === 'select' && _react2.default.createElement('i', { className: (0, _classnames4.default)(_inputStyles2.default.arrow, 'mdv-expand_more') })
  );
};
