...
var Button = function Button(_ref) {
  ...
  var classes = (0, _classnames3.default)(_buttonStyles2.default.button, className, (_classnames = {}, _defineProperty(_classnames, _buttonStyles2.default.primary, primary && !flat), _defineProperty(_classnames, _buttonStyles2.default.secondary, secondary && !flat), _defineProperty(_classnames, _buttonStyles2.default.disabled, disabled), _defineProperty(_classnames, _buttonStyles2.default.large, large), _defineProperty(_classnames, _buttonStyles2.default.flat, flat), _defineProperty(_classnames, _buttonStyles2.default.primaryFlat, flat && primary), _defineProperty(_classnames, _buttonStyles2.default.secondaryFlat, flat && secondary), _defineProperty(_classnames, _buttonStyles2.default.withText, children), _classnames));
  ...
  var iconProps = flat ? { primary: primary, secondary: secondary, disabled: disabled } : {};
  ...
  return !href ? _react2.default.createElement(
    'button',
    _extends({}, commonProps, { type: type }),
    childrenComponent
  ) : _react2.default.createElement(
    'a',
    _extends({}, linkProps, commonProps),
    childrenComponent
  );
};
