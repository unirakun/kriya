...
exports.default = function () {
  ...
  switch (type) {
    case _bottomSheets.OPEN_BOTTOMSHEETS:
      return _extends({}, state, _defineProperty({}, payload.code, { print: true, contents: payload.contents }));
    case _bottomSheets.CLOSE_BOTTOMSHEETS:
      return _extends({}, state, _defineProperty({}, payload, _extends({}, state[payload], { print: false })));
    case _bottomSheets.TOGGLE_BOTTOMSHEETS:
      return _extends({}, state, _defineProperty({}, payload, _extends({}, state[payload], { print: !(state[payload] && state[payload].print) })));
    default:
      return state;
  }
};